	...
	public static void execute(LevelAccessor world, Entity entity, ItemStack itemstack) {
		...
		if (world instanceof ServerLevel _origLevel) {
			...
			world = _origLevel.getServer()
					.getLevel(ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("kingdom_warriors:dark_city")));
			if (world != null) {
				if (entity.isShiftKeyDown()
					...
					} else if (EnchantmentHelper.getItemEnchantmentLevel(KingdomWarriorsModEnchantments.SWIFT_SNEAK_ENCHANTMENT.get(),
							itemstack) == 2) {
						if (entity instanceof LivingEntity _entity)
